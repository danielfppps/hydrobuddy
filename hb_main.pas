...
const
  {$IFDEF UNIX}
  water_quality_db = 'waterquality_unix.dbf';
  formulations_db = 'formulations_unix.dbf' ;
  substances_db = 'substances_unix.dbf';
  substances_used_db = 'substances_used_unix.dbf';
  {$ENDIF}
